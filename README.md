...
> Okey turc — jeu de tuiles 4 joueurs, façon rummy.

[![Build APK](https://github.com/salistar/sally-okey/actions/workflows/android-build.yml/badge.svg)](https://github.com/salistar/sally-okey/actions/workflows/android-build.yml)
[![Lint & Test](https://github.com/salistar/sally-okey/actions/workflows/lint-and-test.yml/badge.svg)](https://github.com/salistar/sally-okey/actions/workflows/lint-and-test.yml)

App mobile faisant partie de la suite **SallyCards** — Expo SDK 52, React Native 0.76, Hermes, expo-router.

| | |
|---|---|
| **Bundle ID Android** | `com.sallycards.okey` |
| **Bundle ID iOS** | `com.sallycards.okey` |
| **Couleur thème** | `#0891B2` |
...
- Okey turc classique avec 106 tuiles + jokers
- Multi-joueur 4 personnes en ligne
- Voice chat WebRTC entre joueurs
- Bots IA (3 niveaux)
- Animations de pose / pioche / défausse
- 5 langues
...
```powershell
git clone https://github.com/salistar/sally-okey.git
cd sally-okey
npm install
npx expo start
...
subst Y: C:\Users\$env:USERNAME\Desktop\sally-okey
cd Y:\
...
# Install + launch
adb uninstall com.sallycards.okey 2>$null
adb install -r app\build\outputs\apk\debug\app-debug.apk
adb shell am start -n com.sallycards.okey/.MainActivity
...
keytool -genkeypair -v -storetype PKCS12 `
  -keystore okey.keystore -alias okey `
  -keyalg RSA -keysize 2048 -validity 10000

# 2) Configurer android/gradle.properties
@"
OKEY_UPLOAD_STORE_FILE=okey.keystore
OKEY_UPLOAD_KEY_ALIAS=okey
OKEY_UPLOAD_STORE_PASSWORD=<password>
OKEY_UPLOAD_KEY_PASSWORD=<password>
