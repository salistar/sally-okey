/**
 * OkeyEngine - Moteur de jeu Okey marocain
 ...
 *   est rompue par un "Okey!" (contestation) ou quand tout le monde passe
 *   sans contester (alors le joueur suivant peut recommencer avec une nouvelle
 *   valeur — cela clôt la séquence précédente).
 * - N'importe quel autre joueur peut crier "Okey!" pour contester
...
export type GamePhase =
  ...
  | 'challenging'  // Fenêtre de contestation "Okey!"
...
export function gameReducer(state: GameState, action: GameAction): GameState {
  switch (action.type) {
    ...
    case 'PLAY_CARD': {
      ...
      // poser une carte (= renoncer à crier Okey) OU appuyer sur Okey.
      ...
      // Seule une contestation Okey! ou un nouveau round peut rompre la
