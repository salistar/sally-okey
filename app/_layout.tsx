/**
 * @file _layout.tsx
 * @description Root layout for Okey. Hydrates theme + locale via
...
console.log('[Okey/_layout] module loaded');
...
export default function RootLayout() {
  console.log('[Okey/_layout] RootLayout rendering');
...
/* === End of _layout.tsx — Okey — SallyCards === */
